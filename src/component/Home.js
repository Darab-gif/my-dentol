...
export const Home = () => {
  return (
    <section className="flex gap-10 bg-hero bg-cover h-[60rem]">
      <div className="pt-[20rem] w-[50%] ml-40">
        ...
        <p className="text-xl pt-8 text-oxford_blue opacity-[0.8]">
        ...
        <form action="" className="inline-flex pt-12">
          <input type="text" className="px-20" />
